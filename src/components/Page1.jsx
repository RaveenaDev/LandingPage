...
const Page1 = () => {
  return (
    <div className='Page1 w-full min-h-screen'>
        ...
        <div className="content absolute top-40 h-[360px] md:h-[280px] w-[800px] p-7 backdrop-blur-lg bg-white bg-opacity-45 rounded-2xl  ">
        ...
        <div className="icons absolute md:top-[62%] md:left-[2%] left-[10%]  flex items-center justify-center gap-3 text-white">
